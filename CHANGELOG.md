...
* Grand Prix highscores, by mrbubax10
...
* In the result screen, display the race position with a number with 10 karts or more, by mrbubax10
...
#### In-race UI
* Add visual and sound feedback when a timed challenge or timed game is about to end, by mrbubax10 and Alayan
