...
2. Download the SuperTuxKart source package from either the latest stable version[SuperTuxKart download area - SourceForge.net](https://sourceforge.net/projects/supertuxkart/files/SuperTuxKart/) or the development version[SuperTuxKart.net - Source Control](https://supertuxkart.net/Source_control), and unpack it. If you want the development version you will need to follow 2a and 2b.
...
2a. If you downloaded the stable version you can skip this point. If you want the development version, you will need a Git client and a SVN client. For Git, install [Git for Windows](https://github.com/git-for-windows/git/releases/latest). If you want a graphical interface for Git you can choose whichever works for you; otherwise if you don't know which to choose you can install [TortoiseGit](https://tortoisegit.org/download) as well after installing Git for Windows. For SVN you can choose whichever works for you, but if you don't know which to choose you can install [TortoiseSVN](https://tortoisesvn.net/downloads.html).
2b. If you downloaded the stable version you can skip this point. Now after doing 2a, open your file browser and find somewhere you want to put the development version of SuperTuxKart. For example in C:\Users\<Your Username> as the Git and SVN clients will have write permissions there, and you should create a directory, for example SuperTuxKart-dev. Enter that directory, and create a directory inside called stk-assets, and enter it. If you installed TortoiseSVN, right-click and select TortoiseSVN -> Checkout... which should bring up a window. In the field called "URL of repository" paste the URL found in [SuperTuxKart.net - Source Control](https://supertuxkart.net/Source_control) after "svn checkout" and press OK. While it is downloading the game assets, go back to your file browser and go one level up, to the directory we suggested to name SuperTuxKart-dev. Once there, right-click again somewhere empty and select "Git clone..." which should bring up a window. In the URL field paste the link found in [SuperTuxKart.net - Source Control](https://supertuxkart.net/Source_control) after "git clone" and press OK.
3. Download the Windows dependencies package from either [SuperTuxKart download area: Dependencies - SourceForge.net](https://sourceforge.net/projects/supertuxkart/files/SuperTuxKart%20Dependencies/Windows/) if you downloaded the stable version of SuperTuxKart and unpack it,
or go to SuperTuxKart-dev in your file browser, right-click somewhere empty, select "Git clone..." and paste https://github.com/supertuxkart/dependencies.git in the URL field and click OK. Then, copy the `dependencies` directory from either the `windows` or the `windows_64bit` directories into the `stk-code` directory; rename it to `dependencies-64bit` if you want to compile a 64-bit build.
...
CMake will begin creating the required files for the build in the directory. If you want to do a 64-bit build, select the version of Visual Studio you installed with "Win64" appended.
