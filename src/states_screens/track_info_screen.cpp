...
void TrackInfoScreen::loadedFromFile()
{
    ...
    m_ai_kart_spinner_allies   = getWidget<SpinnerWidget>("ai-spinner-allies");
    m_ai_kart_label_allies     = getWidget <LabelWidget>("ai-text-allies");
...
void TrackInfoScreen::init()
{
    ...
    m_ai_kart_spinner_allies->setVisible(false);
    m_ai_kart_label_allies->setVisible(false);
    ...
    if (m_is_soccer)
    {
        ...
        if(UserConfigParams::m_num_allies > max_arena_players)
                                   ...
                                   const int playerID)
{
    ...
    else if (name=="ai-spinner-allies")
    {
        UserConfigParams::m_num_allies = m_ai_kart_spinner_allies->getValue();
    }
}   // eventCallback
