...
void CustomVideoSettingsDialog::beforeAddingWidgets()
{
    ...
    getWidget<CheckBoxWidget>("hq-mipmap")->setState(UserConfigParams::m_hq_mipmap);
    ...
    //I18N: Geometry level disabled : lowest level, just basic details
    geometry_level->addLabel(_("Low"));
    //I18N: Geometry level low : some more details are displayed
