...
public:
    ...
    */
    ...
    // ------------------------------------------------------------------------
    void setGrandPrix(const GrandPrix &gp)
    {
        m_grand_prix = gp;
        m_coin_target = 0;
    }
    ...
    // ------------------------------------------------------------------------
    const GrandPrix *getGrandPrix() const { return &m_grand_prix; }
    // ------------------------------------------------------------------------
    ...
    /**
      ...
      */
    void  startGP(const GrandPrix* gp, bool from_overworld,
