...
namespace UserConfigParams
{
    ...
    PARAM_PREFIX BoolUserConfigParam          m_karts_color_gui
            PARAM_DEFAULT(  BoolUserConfigParam(false, "karts-color-gui",
            &m_race_setup_group, "Show karts' colors in race gui icon list.") );
