...
void FontWithFace::setDPI()
{
    ...
    else
    {
        ...
        if (screen_height > 2000 || screen_width > 3000)
            scale = std::max(0, screen_width - 1000) / 800.0f;
        // fix 5k and 8k
        if (screen_height > 2800 || screen_width > 4500)
            scale = std::max(0, screen_width - 1200) / 1000.0f;
        if (screen_height > 3800 || screen_width > 6000)
            scale = std::max(0, screen_width - 1500) / 1300.0f;
