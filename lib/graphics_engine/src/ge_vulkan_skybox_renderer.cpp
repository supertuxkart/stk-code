                                       ...
                                       irr::scene::ISceneNode* skybox)
{
    ...
    g_diffuse_env_cubemap = new GEVulkanEnvironmentMap(sky_tex,
        VK_IMAGE_VIEW_TYPE_CUBE, swap_pixels, true);
    g_specular_env_cubemap = new GEVulkanEnvironmentMap(sky_tex,
        VK_IMAGE_VIEW_TYPE_CUBE, swap_pixels, false);
